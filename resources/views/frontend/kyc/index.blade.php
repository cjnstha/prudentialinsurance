...
{{--					                                <th>View File</th>--}}
                                            ...
                                            @forelse($kycs as $kyc)
					                            <tr>
					                                <td data-label="Name" title="AGM Minute">{{$kyc->kyc_name}}</td>
					                                <td data-label="Date Added">{{$kyc->updated_at}}</td>
...
{{--					                                </td>--}}
					                                <td data-label="Download File">
					                                    <a href="../public/storage/{{$kyc->kyc_file}}" title="Download Attachment" class='btn' download target='_blank'><span><i class="fa fa-file-pdf-o" aria-hidden="true"></i></span> Download <i class="fa fa-download" aria-hidden="true"></i></a>
					                                </td>
					                            </tr>
                                            @empty
