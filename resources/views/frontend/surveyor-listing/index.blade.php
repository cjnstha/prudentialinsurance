...
@section('title')
    Surveyor Listing Application Form
@endsection
@section('contents')
<!-- ========================== Inner Banner =================== -->
	<section class="inner_banner">
		<div class="container">
			<div class="banner-title">
				<h1>Surveyor Listing Application Form </h1>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8 col-md-6 col-sm-6 col-xs-3">
					<h5>Surveyor Listing Application Form</h5>
				</div>
				<div class="col-lg-4 col-md-6 col-sm-6 col-xs-9" style="text-align:right;">
					<ul>
						<li><a href="index.html">Home</a></li>
						<li class="dot"></li>
						<li>Surveyor Listing Application Form</li>
					</ul>
				</div>
			</div>
		</div>
...
{{--					                                <th>View File</th>--}}
                                            ...
                                            @forelse($surveyors as $surveyor)
					                            <tr>
					                                <td data-label="Name" title="AGM Minute">{{$surveyor->surveyor_name}}</td>
					                                <td data-label="Date Added">{{$surveyor->updated_at}}</td>
...
{{--					                                </td>--}}
					                                <td data-label="Download File">
					                                    <a href="../public/storage/{{$surveyor->surveyor_files}}" title="Download Attachment" class='btn' download target='_blank'><span><i class="fa fa-file-pdf-o" aria-hidden="true"></i></span> Download <i class="fa fa-download" aria-hidden="true"></i></a>
					                                </td>
					                            </tr>
                                            @empty
