    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-5 col-sm-5 col-xs-12 top_header_left">
                <p><a href="mailto:picl@prudential.com.np"> <span class="icon"><img
                                src="{{asset('images/front_img/home/email.png')}}" alt="image"></span> Email Us:&nbsp;
                        picl@prudential.com.np </a></p>
                <p><a href="mailto:picl@prudential.com.np"> <span class="icon"><img
                                src="{{asset('images/front_img/home/skype.png')}}" alt="image"> </span> Skype:&nbsp;
                        prudential.insurance</a></p>
            </div>
            <div class="col-lg-6 col-md-7 col-sm-7 col-xs-12 top_header_right">
                <a href="#" class="button-main hvr-sweep-to-rightB read_more transition3s"><img
                        src="{{asset('images/front_img/home/claim.png')}}" alt="image"> Make Claim</a> <a href="#"
                                                                                                          class="button-main hvr-sweep-to-rightB read_more transition3s"><img
                        src="{{asset('images/front_img/home/calculator.png')}}" alt="image"> Calculation</a>
